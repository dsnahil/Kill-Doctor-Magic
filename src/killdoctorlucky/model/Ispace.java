...
public interface Ispace {
  ...
  /**
   * Sets a flag indicating whether this space currently has the pet.
   *
   * @param flag true if the pet is in this space, false otherwise
   */
  void setHasPet(boolean flag);

  /**
   * Checks if this space currently has the pet.
   *
   * @return true if the pet is in this space, false otherwise
   */
  boolean getHasPet();
}
